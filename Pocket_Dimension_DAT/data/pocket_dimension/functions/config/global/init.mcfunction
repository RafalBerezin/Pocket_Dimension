...
execute unless score #pd.config.global.portal.defaults.uses PDFlag = #pd.config.global.portal.defaults.uses PDFlag run scoreboard players set #pd.config.global.portal.defaults.uses PDFlag 0