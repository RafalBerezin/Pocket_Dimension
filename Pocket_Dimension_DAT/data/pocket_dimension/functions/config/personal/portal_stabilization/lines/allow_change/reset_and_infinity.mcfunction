...
execute if score #pd.temp.infinity PDFlag matches 0 run function pocket_dimension:config/personal/portal_stabilization/lines/allow_change/reset_and_infinity/cannot_set_infinity
execute if score #pd.temp.infinity PDFlag matches 1 run function pocket_dimension:config/personal/portal_stabilization/lines/allow_change/reset_and_infinity/can_set_infinity