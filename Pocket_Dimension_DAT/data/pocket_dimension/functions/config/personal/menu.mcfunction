...
function pocket_dimension:config/personal/lines/path
function pocket_dimension:config/personal/lines/privacy
function pocket_dimension:config/personal/lines/portal
